...
There are also a few sidequests here and there, mainly about reverse engineering, web exploitation and cryptography. The crypto one kept me busy for __**three days**__ as I usually don't even look at crypto challenges in CTFs, but in the end I learned a ton about ECDSA and ElGamal encryption algorithm.
