...
Ok, now that I have overtaken blank page anxiety (bear with me okay?) we can start talking more seriously. Recently I was involved in a internal penetration test of a big organization which had networks spread across many European countries. It was a multi-step operation, with my work being the second step, after the initial compromise performed by other guys who landed a shell on the frontend through a web application. Long story short, the operation was a big success (full compromission) because of some basic misconfigurations of their Active Directory environment. Stuff like this happens very often as AD is not easy.
